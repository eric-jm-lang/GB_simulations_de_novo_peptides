...
for i in 7; do
    for j in ff14SB ff03.r1 fb15 ff15ipq; do #note that it is leaprc.protein.ff14SB for example
      for k in E4K42 K4E42; do
    
      mkdir ../4-Run2/igb${i}_${j}_${k}
      cp ${k}_capped.pdb ../4-Run2/igb${i}_${j}_${k}
