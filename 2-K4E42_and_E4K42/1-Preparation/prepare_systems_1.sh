...
for i in 1 2 5 8; do
  for j in ff14SB ff03.r1; do #note that it is leaprc.protein.ff14SB for example
  #for j in ff99 ff99SB ff99SBildn ff99SBnmr ff96 ff94 ff14ipq ff98; do #note that it is in oldff/leaprc.ff99 for example
    for k in E4K42 K4E42; do
      ...
      mkdir ../igb${i}_${j}_${k}
      cp ${k}_capped.pdb ../igb${i}_${j}_${k}
      cd ../igb${i}_${j}_${k}
  ...
  cat > tleap_$i.in <<EOF
source leaprc.protein.$j 
set default PBRadii $radii
prot1 = loadPDB ${k}_capped.pdb
...
#
export MYDIR=\"/panfs/panasas01/bluegem-t2/el14718/5-Folding/9-A4_K4E4_A4_K4E4_A4_folded_2/igb${i}_${j}_${k}\"
#
old=HMR
cd \$MYDIR
...
export MYDIR=\"/mnt/storage/scratch/el14718/5-Folding/10-K4E42_and_E4K42_folded_2/igb${i}_${j}_${k}\"
#
old=HMR
cd \$MYDIR
for name in min1 min2 heat eq1 eq2 md1; do
