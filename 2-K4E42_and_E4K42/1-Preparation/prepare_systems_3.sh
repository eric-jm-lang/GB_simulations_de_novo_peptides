...
for i in 7; do
    for j in ff14SB ff14SBonlysc ff03.r1 fb15 ff15ipq; do #note that it is leaprc.protein.ff14SB for example
      for k in E4K42 K4E42; do
    
      mkdir ../2-Run1/igb${i}_${j}_${k}
      cp ${k}_capped.pdb ../2-Run1/igb${i}_${j}_${k}
...
#
old=HMR
for name in min1 min2 heat eq1 eq2 md1 md2; do
