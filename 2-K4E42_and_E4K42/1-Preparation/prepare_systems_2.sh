...
for i in 1 2 5 8; do
  for j in ff99SBnmr ff96 ff94 ff98; do #note that it is in oldff/leaprc.ff99 for example
...
#
export MYDIR=\"/panfs/panasas01/bluegem-t2/el14718/5-Folding/10-K4E42_and_E4K42_folded_2/igb${i}_${j}_${k}\"
#
old=HMR
cd \$MYDIR
